...
rank_and_nb_group<-function(df, var, order="Descending", peers="Current",
                            plot_title="",y_title="", subtitle_text = "", caption_text = ""){
  df$var <- df[[var]]
  if(peers=="Current"){
  ...
  p = p + theme(text = element_text(family = "Liberation Sans"),
                plot.title = element_text(family = "Liberation Sans", size = 18, hjust = 0.5),
                axis.text.y=element_text(hjust=0, face = rev(d.graph$textfont),
                                         size=12, family = "Liberation Sans", color = rev(d.graph$textcolor)),
                axis.ticks=element_blank(),
                axis.text.x = element_blank(),
                plot.caption = element_text(family = "Liberation Sans"),
                plot.subtitle = element_text(family = "Liberation Sans", hjust = 0.5))
...
```{r}
rank_and_nb_group(chr_rescale, "outcomes", plot_title = "Health Outcomes, 2017", subtitle_text = "County Health Rankings, Robert Wood Johnson Foundation", caption_text = "Source: Greater Louisville Project \n Data from Robert Wood Johnson Foundation")
```
```{r}
rank_and_nb_group(chr_z, "health_behaviors", plot_title = "Health Behaviors, 2017", subtitle_text = "County Health Rankings, Robert Wood Johnson Foundation", caption_text = "Source: Greater Louisville Project \n Data from Robert Wood Johnson Foundation")
```

```{r}
rank_and_nb_group(chr_z, "clinical_care", plot_title = "Clinical Care, 2017", subtitle_text = "County Health Rankings, Robert Wood Johnson Foundation", caption_text = "Source: Greater Louisville Project \n Data from Robert Wood Johnson Foundation")
```

```{r}
rank_and_nb_group(chr_z, "social_and_economic", plot_title = "Social and Economic Health Factors, 2017", subtitle_text = "County Health Rankings, Robert Wood Johnson Foundation", caption_text = "Source: Greater Louisville Project \n Data from Robert Wood Johnson Foundation")
```

```{r}
rank_and_nb_group(chr_z, "physical_environment", plot_title = "Physical Environment, 2017", subtitle_text = "County Health Rankings, Robert Wood Johnson Foundation", caption_text = "Source: Greater Louisville Project \n Data from Robert Wood Johnson Foundation")
```

```{r}
rank_and_nb_group(chr_z, "factors", plot_title = "Combined Health Factors, 2017", subtitle_text = "County Health Rankings, Robert Wood Johnson Foundation", caption_text = "Source: Greater Louisville Project \n Data from Robert Wood Johnson Foundation")
```
